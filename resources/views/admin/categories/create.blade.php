                            ...
                            <form action="{{route('category.store')}}" method="POST">
                                ...
                                <div class="col-sm-10 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input " type="radio" name="visibility" id="non_visible" value="0" checked aria-label="Radio button for following text input">
                                        <label class="form-check-label" for="non_visible">Non visible</label>
                                    </div>
