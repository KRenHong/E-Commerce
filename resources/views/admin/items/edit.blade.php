                ...
                <div class="col-sm-12 ">
                    <div class="card p-3">
                        <div class="card-title border-bottom">
                            <h3><i class="fa fa-store"></i> Edit Product "{{$item->title}}"</h3>
                        </div>
                        ...
                        <div class="card-body">
                            <form action="{{route('item.update',$item->slug)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10 col-sm-9">
                                        <textarea name="description" id="desc" cols="30" rows="9" class="form-control" >{{$item->description}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="input-group mt-3 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="old-price" name="Old_price" value="{{$item->Old_price}}">
                                    <span class="input-group-text">RM</span>
                                    <span class="input-group-text">0.00</span>
                                </div>
                                ...
                                <div class="col-sm-10 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input " type="radio" name="in_Stock" id="non_dispo" {{$item->in_Stock===0?"checked":""}} value="0" aria-label="Radio button for following text input">
                                        <label class="form-check-label" for="non_dispo">Not available in stock</label>
                                    </div>

                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="in_Stock" id="dispo" value="1" {{$item->in_Stock===1?"checked":""}}>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10 col-sm-9">
                                        <input type="number" name="Qte" id="qte" class="form-control" value="{{$item->Qte}}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10 col-sm-9">
                                        <input type="text" name="Country_Mad" id="cm" class="form-control" value="{{$item->Country_Mad}}">
                                    </div>
                                </div>
